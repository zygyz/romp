  ...
  //int j;
{
    ...
    int c4;
    if (n >= 1) {
#pragma omp parallel for private(c4, c2, c3) schedule(dynamic)
  ...
  //#pragma scop
{
    ...
    if (n >= 1 && tsteps >= 1) {
      for (c0 = 0; c0 <= tsteps + -1; c0++) {
        if (n >= 2) {
#pragma omp parallel for private(c15, c9, c8) schedule(dynamic)
          for (c2 = 0; c2 <= (((n + -1) * 16 < 0?((16 < 0?-((-(n + -1) + 16 + 1) / 16) : -((-(n + -1) + 16 - 1) / 16))) : (n + -1) / 16)); c2++) {
...
#pragma omp parallel for private(c15) schedule(dynamic)
        for (c2 = 0; c2 <= (((n + -1) * 16 < 0?((16 < 0?-((-(n + -1) + 16 + 1) / 16) : -((-(n + -1) + 16 - 1) / 16))) : (n + -1) / 16)); c2++) {
#pragma omp simd
          for (c15 = 16 * c2; c15 <= ((16 * c2 + 15 < n + -1?16 * c2 + 15 : n + -1)); c15++) {
