...
#		pragma omp task firstprivate(q,i, switchThresh, myVecPtr)
		{
			myQuickSort(*myVecPtr, q, i - 1, switchThresh);
		}
//#		pragma intel omp task
#		pragma omp task firstprivate(r,i, switchThresh, myVecPtr)
		{
			myQuickSort(*myVecPtr, i + 1, r, switchThresh);
		}
	}
}
...
#	pragma omp parallel shared (myVec, numThreads) firstprivate(switchThresh)
	{
//#		pragma intel omp taskq
#pragma omp single
		{
